...
class DataProcessor:
    ...
    def load_data(self, usecols):
        try:
            ...
            raise CustomException(f"Error loading data from {self.input_file}: {e}", sys.exc_info())
    ...
    def filter_users(self, min_rating = 400):
        try:
            ...
            raise CustomException(f"Error filtering users: {e}", sys.exc_info())
    ...
    def save_artifacts(self):
        try:
            ...
            logger.info("All the training artifacts saved successfully in processed directory")
    ...
    def process_anime_data(self):
        try:
            ...
            logger.info("Anime with synopsis data processed and saved successfully")
    ...
    def run(self):
        try:
            ...
            logger.error(f"Data processing failed: {str(ce)}")
        finally:
